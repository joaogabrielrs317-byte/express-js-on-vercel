    ...
    >
      <TiltedCard rotateAmplitude={8} scaleOnHover={1.03}>
        <Link
          ...
          className="group block rounded-2xl overflow-hidden border border-ink-100 dark:border-ink-800 bg-white dark:bg-ink-900 hover:border-ink-300 dark:hover:border-ink-600 hover:shadow-xl transition-all duration-300"
